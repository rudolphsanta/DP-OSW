...
text(x = 20, y = 0.118, "Wind Speed Class 14 \n Mean = 7.04 m/s", col = 'red',adj = c(0,1))
shape::Arrows(x0=19.95,y0=0.115, x1 = 7.8, y1 = 0.115, col = 'red')
text(x = 20, y = 0.093, "Portuguese Wind Profile \n Mean = 8.86 m/s", col = 'blue',adj = c(0,1))
shape::Arrows(x0=19.95,y0=0.09, x1 = 10, y1 = 0.09, col = 'blue')
...
mtext("Probability Density", side = 2, line = 4.5, cex = 1, col = "black")
dev.off()
...
parasitic.power15 <- DP.Power.n(DLC1.3_15, motor.diam = 3.8, n = 30)
...
setEPS()
postscript("Figure 4b_v1.eps", width = 7.5, height = 5)
par(mar = c(4, 5, 2, 5))
plot(x = speeds, y = DP.Effective.Power15, type = 'l', lwd = 3,
...
text(x = 25, y = 3.25, "Power Ratio", col = '#0000FF', adj = 1, cex = 0.8)
text(x = 25, y = 1.5, "Thruster Power Consumption", col = '#FF0000', adj = 1, cex = 0.8)
text(x = 25, y = 13.5, "Net Power Output", col = 'black', adj = 1, cex = 0.8)
...
axis(side = 1, pos = -5, cex.axis = 1)
mtext("Wind Speed [m/s]", side = 1, line = 2.5, cex = 1, col = "black")
...
#WEIBULL PARAMETERS
sensitivity_15 <- function(shape, scale, OCC.High, OCC.Low, FOM.High, FOM.Low, disc.r, years = 25, fs = 1.67) {
  P.shape = shape
  P.scale = scale
  Turbine <- 15
  # #From NREL ATB 2021
...
sensitivity_15(shape = 2.3, scale = 10.82, OCC.High = 3969, OCC.Low = 3630, FOM.High = 88, FOM.Low = 80, disc.r = 0.052, years = 30)
